...
While theoretically both are achievable, it was decided that the time complexity that each query would have is not worth separating the data from the dataset into more than 1 table.
